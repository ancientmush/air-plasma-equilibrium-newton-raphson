module mod_types
    ...
    type, abstract, extends(atom) :: intermediate !化合物などを実装するための中間型
	integer :: atendee
	...
	module subroutine storing(this) ! 各化学種のデータをぶち込む
    ...
    type, extends(intermediate) :: molecule !N2など
    contains
    ...
    type, extends(intermediate) :: ion !O+など
    contains
	procedure :: delta_g => ionization
    end type ion

    type, extends(molecule) :: imolecule ! O2+など
    contains
